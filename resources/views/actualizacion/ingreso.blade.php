                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('actualizacion') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="text" class="form-control @error('apellido') is-invalid @enderror" name="telefono" value="{{ old('telefono') }}" required autocomplete="telefono" autofocus>
